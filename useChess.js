...
* Nel name mi memorizzo la loro posizione x-z sulla scacchiera, mentre in id ho colore-posizione nell'array-pezzo */
	loader.load("http://127.0.0.1:8080/models/wpawn.js",function(geometry,materials) {
	...
	loader.load("http://127.0.0.1:8080/models/wrook.js",function(geometry,materials) {
	...
	loader.load("http://127.0.0.1:8080/models/wknight.js",function(geometry,materials) {
	...
	loader.load("http://127.0.0.1:8080/models/wking.js",function(geometry,materials) {
	...
	loader.load("http://127.0.0.1:8080/models/wqueen.js",function(geometry,materials) {
...
// Creo i pezzi neri, per cui vale quando detto per i bianchi
	loader.load("http://127.0.0.1:8080/models/bpawn.js",function(geometry,materials) {
	...
	loader.load("http://127.0.0.1:8080/models/brook.js",function(geometry,materials) {
	...
	loader.load("http://127.0.0.1:8080/models/bknight.js",function(geometry,materials) {
	...
	loader.load("http://127.0.0.1:8080/models/bking.js",function(geometry,materials) {
	...
	loader.load("http://127.0.0.1:8080/models/bqueen.js",function(geometry,materials) {
